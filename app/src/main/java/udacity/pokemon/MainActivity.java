        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (jsonString != null) {
                try {
                    ...
                    JSONObject pokemonRoot = new JSONObject(jsonString);

                    JSONArray pokemons = pokemonRoot.getJSONArray("pokemon");
                    ...
                    for (int i = 0; i < pokemons.length(); i++) {
                        ...
                        String id = pokemonData.getString("id");
                        String candy = pokemonData.getString("candy");
